            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="text-center">
                                <strong>当月单量统计</strong>
                            </p>

                            <div class="chart">
                                <!-- Sales Chart Canvas -->
                                <canvas id="salesChart" style="height: 280px; width: 1072px;" width="1072" height="280"></canvas>
                            </div>
                            <!-- /.chart-responsive -->
                        </div>
                        <!-- /.col -->
...
@section('js')
    ...
    <script>
        ...
        var myBarChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["2019-04-01", "2019-04-02", "2019-04-03", "2019-04-04", "2019-04-05", "2019-04-06", "2019-04-07", "2019-04-08", "2019-04-09", "2019-04-10", "2019-04-11", "2019-04-12", "2019-04-13", "2019-04-14"],
                datasets: [
                    {
                        label: "平台",
                        ...
                        data: [65, 59, 80, 81, 56, 55, 40, 50, 98, 10, 36, 58, 98, 100]
                    },
                    {
                        label: "sdk",
                        ...
                        data: [28, 48, 40, 19, 86, 27, 90, 900, 500, 260, 128, 352, 158, 322]
                    }
                ]
            },
            options: {
